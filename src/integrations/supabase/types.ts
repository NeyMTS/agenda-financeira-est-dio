  ...
  public: {
    Tables: {
      ...
      studio_appointment_deposits: {
        ...
        Relationships: [
          {
            foreignKeyName: "studio_appointment_deposits_appointment_id_fkey"
          ...
          {
            foreignKeyName: "studio_appointment_deposits_household_id_fkey"
            columns: ["household_id"]
            isOneToOne: false
            referencedRelation: "households"
            referencedColumns: ["id"]
      ...
      transactions: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["deposit_id"]
            isOneToOne: false
            referencedRelation: "studio_appointment_deposits"
            referencedColumns: ["id"]
          },
          {
